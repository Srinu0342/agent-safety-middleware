...
router.post("/:provider/v1/messages", async (req: Request, res: Response) => {
  ...
  switch (provider) {
    ...
    case PROVIDERS.OPENAI:
      openaiCallHandler(forwardHeaders, body, req, res, requestId, sessionId, sessionLog, CLI.CLAUDE_CODE);
      break;
